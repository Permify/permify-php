...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/v1.5.4/PHP';
    ...
    {
        $report  = 'PHP SDK (Permify) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.5.4' . PHP_EOL;
        $report .= '    SDK Package Version: v1.5.4' . PHP_EOL;
