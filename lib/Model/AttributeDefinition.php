...
class AttributeDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'type' => '\Permify\Model\AttributeType'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the attribute, which follows a specific string pattern and has a maximum byte size.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Permify\Model\AttributeType|null
     */
     ...
     * Sets type
     *
     * @param \Permify\Model\AttributeType|null $type type
     *
     * @return self
     */
