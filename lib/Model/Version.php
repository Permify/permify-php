...
class Version implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets major
     *
     * @param string|null $major Major version changes indicate different required support level from the required components.
     *
     * @return self
     */
     ...
     * Sets minor
     *
     * @param string|null $minor Minor version changes must not change the observed behavior from existing implementations, but may be provided informationally.
     *
     * @return self
     */
