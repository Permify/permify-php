...
class Child implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'leaf' => '\Permify\Model\Leaf',
        'rewrite' => '\Permify\Model\Rewrite'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rewrite', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets leaf
     *
     * @return \Permify\Model\Leaf|null
     */
     ...
     * Sets leaf
     *
     * @param \Permify\Model\Leaf|null $leaf leaf
     *
     * @return self
     */
     ...
     * Gets rewrite
     *
     * @return \Permify\Model\Rewrite|null
     */
     ...
     * Sets rewrite
     *
     * @param \Permify\Model\Rewrite|null $rewrite rewrite
     *
     * @return self
     */
    ...
    {
        if (is_null($rewrite)) {
            throw new \InvalidArgumentException('non-nullable rewrite cannot be null');
        }
