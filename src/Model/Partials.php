 ...
 */
class Partials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Partials';
    ...
    */
     ...
     * Sets delete
     *
     * @param string[]|null $delete delete
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param string[]|null $update update
     *
     * @return self
     */
